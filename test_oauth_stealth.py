...
with sync_playwright() as p:
    print("Launching chrome with evasion...")
    ...
    page.screenshot(path="C:\\Users\\PC\\.gemini\\antigravity-ide\\brain\\98487492-efcc-4a4a-9527-94f16c05be12\\oauth_stealth_state.png")
