...
print("Google OAuth Init URL:", oauth_url)
...
with sync_playwright() as p:
    ...
    # Save a screenshot to help debug if it gets stuck
    screenshot_path = r"C:\Users\PC\Desktop\nhacuongthuoc\oauth_custom_final.png"
    ...
    if id_token:
        ...
        # Call the local authenticate endpoint or Rownd API directly
        # Let's call Rownd API directly:
        rownd_url = "https://api.rownd.io/hub/auth/token"
        rownd_payload = {
            "id_token": id_token,
            "app_id": "b6b8e7c0-fb66-4c6c-a391-bbf0a7d8dfcc"
        }
        print("POST to:", rownd_url)
